...
#datasets="/home/chris/projects/tsml-eval/_tsml_research_resources/dataset_lists/Univariate112Datasets.txt"
...
clusterers_to_run="EE-davies-bouldin-twe EE-calinski-harabasz-twe EE-calinski-harabasz-msm EE-davies-bouldin-msm"
...
# ======================================================================================
# ======================================================================================
other_combine_test_train_split=${combine_test_train_split}
...
python -u ${script_file_path} ${clusterer} ${dataset} true ${combine_test_train_split}"  > generatedFile.sub
echo "python -u ${script_file_path} ${clusterer} ${dataset} true ${other_combine_test_train_split}"
