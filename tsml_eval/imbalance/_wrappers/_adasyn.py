...
I have copied all this code from the source because it is unbelievbly annoying that
for SMOTE they call the parameter "k_neighbors" and for ADASYN they call it
"n_neighbors". I don't understand why they would do this. It is very annoying but
I also dont have the energy to open a issue/pr for them lol.
"""
...
class _ADASYN(BaseOverSampler):
    ...
    k_neighbors : int or estimator object, default=5
    ...
    def _validate_estimator(self):
        ...
        self.nn_ = check_neighbors_object(
            "n_neighbors", self.k_neighbors, additional_neighbor=1
        )
